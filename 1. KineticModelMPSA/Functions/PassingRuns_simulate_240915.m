function [MPS_simulation, MPB_simulation, NB_simulation] = PassingRuns_simulate_240915(trials, subjectData, leucineInput, concentrationsIV, kValues, ...
...
% Includes outputs for MPB and NB AUC
    ...
    MPS_simulation = nan(1,trials);
    MPB_simulation = nan(1,trials);
    NB_simulation = nan(1,trials);
