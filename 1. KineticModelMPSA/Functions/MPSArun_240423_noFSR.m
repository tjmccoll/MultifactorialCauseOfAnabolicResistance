function [passTest] = MPSArun_240423_noFSR(trials, subjectData, concentrationsIV, kValues, eqDur, simDur, glucInfRate, leuInfRate, FilePathCumulative)
    ...
    % 240423: FSR criteria removed for anabolic resistance study
        ...
        s = warning('error', 'MATLAB:nearlySingularMatrix');
            ...
            try 
                ...
                MatrixSingular=0;
                        ...
                        % runs
                        % **Updated MPSAcriteria function**
                        passTest(1,k) = MPSAcriteria_240423_noFSR(t, x, x_conc, eqDur);
                        numPass =  sum(passTest==1) % live output of the number of no passing parameter sets
