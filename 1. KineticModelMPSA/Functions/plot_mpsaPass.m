function plot_mpsaPass(figNum, t, x_conc, x_mass, RunDuration, EquilibriumDuration, kValues)

% [CostIndividual, CostTotal, mps_integral_grams] = plot(figNum, t, x_conc, x_mass, ExpData, ...
