function [kValue_lh, concentration_lh, lhSample] = latinHypercuber_231006(kValue_vector, concentration_vector, trials, ...
...
% combining k-values and concentrations into a single array
