function [CostIndividual, CostTotal, mps_integral_grams] = plot_mpsaCriteria(figNum, t, x_conc, x_mass, ExpData, ...
...
% Basal Concentration
pAkt_S_basal = 4.24e-9; pAkt_S_basal_acceptRange = [2, 50];
...
text(EquilibriumDuration+5, middle*0.8, ...
    {'Basal Phos:', '2-50% total Akt'}, ...
...
text(pAkt_S_peakTime+5, middle*1.2, ...
...
% Basal Concentration
p70S6K_T_basal = 1.4e-9; p70S6K_T_basal_acceptRange = [1, 40];
