function [CostIndividual, CostTotal, mps_integral_grams] = plot_Figure_S3_230418(figNum, t, x_conc, x_mass, ExpData, ...
...
subplotTight(height_y, length_x, 34:36)
    ...
    xticks(xTicks)
    xticklabels(xTicksSeq)
    ylim([0.13398 0.13412])
    yticks([0.1340: 0.00005 : 0.1341])
    xlabel('Time (min)', 'fontWeight', 'bold', 'fontSize', fontSize_axes)
