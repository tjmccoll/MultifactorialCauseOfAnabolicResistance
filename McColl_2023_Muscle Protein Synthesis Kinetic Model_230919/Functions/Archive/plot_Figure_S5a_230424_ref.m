function [CostIndividual, CostTotal, mps_integral_grams] = plot_Figure_S5a_230424(figNum, t, x_conc, x_mass, ExpData, ...
...
subplotTight(height_y, length_x, 9:12)
    plot (t, mps, 'LineStyle', '.', 'LineWidth', 2.5, 'Color',[.5 .5 .5]) 
    grid on
        ax=gca;
        ax.FontSize = fontSize_units;
    xlim(x_lim)
