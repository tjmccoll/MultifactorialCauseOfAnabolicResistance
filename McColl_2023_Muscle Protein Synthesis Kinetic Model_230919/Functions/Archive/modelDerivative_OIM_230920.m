function [dx] = modelDerivative_OIM_230920(t, x, KValueVector_given, OptimizeParameters, ...
...
AKT_pT308 = x(20);
Akt_pS473 = x(21);
AKT_pT308_pS473 = x(22);
TSC_clx = x(23);
TSC_p_clx = x(24);
mTORC1_inactive = x(25);
mTORC1_active = x(26);
p70S6K = x(27);
p70S6K_pT389 = x(28);
PI3K_variant = x(29);
