...
setwd("/Users/taylormccoll/Documents/SFU/1. Ph.D./1. Research Projects/2. MPSA and analyses/4. Writing/2. Manuscript/ManuscriptCodeSharing/MultifactorialCauseOfAnabolicResistance/")
  ...
  mps_therapy = data.frame(read.csv("3. TargetedApproach/Output Plots/25-10-04 17-13-28/4_Therapeutic strategies/compensatorySignaling/medians/therapy_compensatorySignalingSims_mpsMedian - 25-11-18 22-21-12.csv",header=F,sep=','))
  mps_sd_therapy = data.frame(read.csv("3. TargetedApproach/Output Plots/25-10-04 17-13-28/4_Therapeutic strategies/compensatorySignaling/medians/therapy_compensatorySignalingSims_mpsSD - 26-03-24 19-27-45.csv",header=F,sep=','))

  mpb_therapy = data.frame(read.csv("3. TargetedApproach/Output Plots/25-10-04 17-13-28/4_Therapeutic strategies/compensatorySignaling/medians/therapy_compensatorySignalingSims_mpbMedian - 25-11-18 22-21-12.csv",header=F,sep=','))
  mpb_sd_therapy = data.frame(read.csv("3. TargetedApproach/Output Plots/25-10-04 17-13-28/4_Therapeutic strategies/compensatorySignaling/medians/therapy_compensatorySignalingSims_mpbSD - 26-03-24 19-27-45.csv",header=F,sep=','))
  
  nb_therapy = data.frame(read.csv("3. TargetedApproach/Output Plots/25-10-04 17-13-28/4_Therapeutic strategies/compensatorySignaling/medians/therapy_compensatorySignalingSims_nbMedian - 25-11-18 22-21-12.csv",header=F,sep=','))
  nb_sd_therapy = data.frame(read.csv("3. TargetedApproach/Output Plots/25-10-04 17-13-28/4_Therapeutic strategies/compensatorySignaling/medians/therapy_compensatorySignalingSims_nbSD - 26-03-24 19-27-45.csv",header=F,sep=','))
```
...
rownames(mps_sd_therapy) <- simulationNames
rownames(mpb_therapy) <- simulationNames
rownames(mpb_sd_therapy) <- simulationNames 
rownames(nb_therapy) <- simulationNames
rownames(nb_sd_therapy) <- simulationNames 
