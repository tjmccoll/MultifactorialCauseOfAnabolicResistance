function [dx] = modelDerivative_250623_targetedSim(t, x, KValueVector_given, OptimizeParameters, ...
    OptimizeParameters_initial, KValueVector_factor, EquilibriumDuration, GlucoseInfRate, ...
    LeucineInfRate_given, p70S6K_basalInput, insulinResistance)
...
if t<EquilibriumDuration
    ...
    KValue(16) = KValue(16)*insulinResistance; % age-related insulin resistance modifier
...
% constitutive (age-related) p70S6K phosphorylation
r40_basal = p70S6K_basalInput * p70S6K;
...
dx(25) = r38 + r43 - r39;
dx(26) = r39 - r38 - r43;
% dx(27) = r42 - r40 - r41; % original (healthy)
% dx(28) = r40 + r41 - r42; % original (healthy)
dx(27) = r42 - r40 - r41 - r40_basal; % age-related constitutive activity
dx(28) = r40 + r41 - r42 + r40_basal; % age-related constitutive activity
